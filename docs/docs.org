...
Stacktrace:
 [1] writedlm_row(::Base.AbstractIOBuffer{Array{UInt8,1}}, ::J4Org.Documented_Item, ::Char, ::Bool) at ./datafmt.jl:651
 [2] #writedlm#18(::Array{Any,1}, ::Function, ::IOStream, ::Array{J4Org.Documented_Item,1}, ::Char) at ./datafmt.jl:674
 [3] #20 at ./datafmt.jl:683 [inlined]
 [4] open(::Base.DataFmt.##20#21{Array{Any,1},Array{J4Org.Documented_Item,1},Char}, ::String, ::String) at ./iostream.jl:152
 [5] #writecsv#23(::Array{Any,1}, ::Function, ::String, ::Array{J4Org.Documented_Item,1}) at ./datafmt.jl:705
 [6] writecsv(::String, ::Array{J4Org.Documented_Item,1}) at ./datafmt.jl:705
