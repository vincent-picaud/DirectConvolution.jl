...
print_org_doc(documented_items,tag="UDWT_Filter",tag_to_ignore="Internal",header_level=0,case_sensitive=true)
 ...
 <<sV6gR6k8>> *Index:* *[U]* [[4SMx3pk2][UDWT_Filter]], [[3LlQxGxz][UDWT_Filter_Biorthogonal]] *[t]* [[OsMAD3Fg][tildeψ_filter]], [[WuIiCEac][tildeψ_offset]], [[DaRShWmY][tildeϕ_filter]], [[dErpo1Mx][tildeϕ_offset]] *[ψ]* [[hBAWz8xt][ψ_filter]], [[UcPJfYpX][ψ_offset]] *[ϕ]* [[dEawQNiu][ϕ_filter]], [[pvuUsbE0][ϕ_offset]] 
 - @@latex:\phantomsection@@ *=UDWT_Filter=*  <<4SMx3pk2>>
 #+BEGIN_SRC julia :eval never :exports code
 ...
 #+END_QUOTE
 [[file:/home/picaud/GitHub/DirectConvolution.jl/src/udwt.jl::35][udwt.jl:35]], [[sV6gR6k8][back to index]]
 - @@latex:\phantomsection@@ *=UDWT_Filter_Biorthogonal=*  <<3LlQxGxz>>
 #+BEGIN_SRC julia :eval never :exports code
 ...
 wavelet transform
 #+END_QUOTE
 [[file:/home/picaud/GitHub/DirectConvolution.jl/src/udwt.jl::9][udwt.jl:9]], [[sV6gR6k8][back to index]]
 - @@latex:\phantomsection@@ *=tildeψ_filter=*  <<OsMAD3Fg>>
 #+BEGIN_SRC julia :eval never :exports code
 tildeψ_filter(c::UDWT_Filter_Biorthogonal)::LinearFilter
 #+END_SRC
 [[file:/home/picaud/GitHub/DirectConvolution.jl/src/udwt.jl::22][udwt.jl:22]], [[sV6gR6k8][back to index]]

 #+BEGIN_SRC julia :eval never :exports code
 tildeψ_filter(c::UDWT_Filter)::LinearFilter
 #+END_SRC
 [[file:/home/picaud/GitHub/DirectConvolution.jl/src/udwt.jl::48][udwt.jl:48]], [[sV6gR6k8][back to index]]
 - @@latex:\phantomsection@@ *=tildeψ_offset=*  <<WuIiCEac>>
 #+BEGIN_SRC julia :eval never :exports code
 tildeψ_offset(c::UDWT_Filter_Biorthogonal)::Int
 #+END_SRC
 [[file:/home/picaud/GitHub/DirectConvolution.jl/src/udwt.jl::30][udwt.jl:30]], [[sV6gR6k8][back to index]]

 #+BEGIN_SRC julia :eval never :exports code
 tildeψ_offset(c::UDWT_Filter)::Int
 #+END_SRC
 [[file:/home/picaud/GitHub/DirectConvolution.jl/src/udwt.jl::54][udwt.jl:54]], [[sV6gR6k8][back to index]]
 - @@latex:\phantomsection@@ *=tildeϕ_filter=*  <<DaRShWmY>>
 #+BEGIN_SRC julia :eval never :exports code
 tildeϕ_filter(c::UDWT_Filter_Biorthogonal)::LinearFilter
 #+END_SRC
 [[file:/home/picaud/GitHub/DirectConvolution.jl/src/udwt.jl::20][udwt.jl:20]], [[sV6gR6k8][back to index]]

 #+BEGIN_SRC julia :eval never :exports code
 tildeϕ_filter(c::UDWT_Filter)::LinearFilter
 #+END_SRC
 [[file:/home/picaud/GitHub/DirectConvolution.jl/src/udwt.jl::45][udwt.jl:45]], [[sV6gR6k8][back to index]]
 - @@latex:\phantomsection@@ *=tildeϕ_offset=*  <<dErpo1Mx>>
 #+BEGIN_SRC julia :eval never :exports code
 tildeϕ_offset(c::UDWT_Filter_Biorthogonal)::Int
 #+END_SRC
 [[file:/home/picaud/GitHub/DirectConvolution.jl/src/udwt.jl::28][udwt.jl:28]], [[sV6gR6k8][back to index]]

 #+BEGIN_SRC julia :eval never :exports code
 tildeϕ_offset(c::UDWT_Filter)::Int
 #+END_SRC
 [[file:/home/picaud/GitHub/DirectConvolution.jl/src/udwt.jl::51][udwt.jl:51]], [[sV6gR6k8][back to index]]
 - @@latex:\phantomsection@@ *=ψ_filter=*  <<hBAWz8xt>>
 #+BEGIN_SRC julia :eval never :exports code
 ψ_filter(c::UDWT_Filter_Biorthogonal)::LinearFilter
 #+END_SRC
 [[file:/home/picaud/GitHub/DirectConvolution.jl/src/udwt.jl::18][udwt.jl:18]], [[sV6gR6k8][back to index]]
 - @@latex:\phantomsection@@ *=ψ_offset=*  <<UcPJfYpX>>
 #+BEGIN_SRC julia :eval never :exports code
 ψ_offset(c::UDWT_Filter_Biorthogonal)::Int
 #+END_SRC
 [[file:/home/picaud/GitHub/DirectConvolution.jl/src/udwt.jl::26][udwt.jl:26]], [[sV6gR6k8][back to index]]
 - @@latex:\phantomsection@@ *=ϕ_filter=*  <<dEawQNiu>>
 #+BEGIN_SRC julia :eval never :exports code
 ϕ_filter(c::UDWT_Filter_Biorthogonal)::LinearFilter
 #+END_SRC
 [[file:/home/picaud/GitHub/DirectConvolution.jl/src/udwt.jl::16][udwt.jl:16]], [[sV6gR6k8][back to index]]
 - @@latex:\phantomsection@@ *=ϕ_offset=*  <<pvuUsbE0>>
 #+BEGIN_SRC julia :eval never :exports code
 ϕ_offset(c::UDWT_Filter_Biorthogonal)::Int
 #+END_SRC
 [[file:/home/picaud/GitHub/DirectConvolution.jl/src/udwt.jl::24][udwt.jl:24]], [[sV6gR6k8][back to index]]
 :END:
...
print_org_doc(documented_items,tag="UDWT_Filter_Available",tag_to_ignore="Internal",header_level=0,case_sensitive=true)
 ...
 <<KnhcZUtD>> *Index:* *[U]* [[A8FkSn0E][UDWT_Filter_Haar]], [[KvUuBRjH][UDWT_Filter_Starck2]] 
 - @@latex:\phantomsection@@ *=UDWT_Filter_Haar=*  <<A8FkSn0E>>
 #+BEGIN_SRC julia :eval never :exports code
 ...
 Haar filter
 #+END_QUOTE
 [[file:/home/picaud/GitHub/DirectConvolution.jl/src/udwt.jl::61][udwt.jl:61]], [[KnhcZUtD][back to index]]
 ...
 Creates an instance
 #+END_QUOTE
 [[file:/home/picaud/GitHub/DirectConvolution.jl/src/udwt.jl::67][udwt.jl:67]], [[KnhcZUtD][back to index]]
 - @@latex:\phantomsection@@ *=UDWT_Filter_Starck2=*  <<KvUuBRjH>>
 #+BEGIN_SRC julia :eval never :exports code
 ...
 #+END_QUOTE
 [[file:/home/picaud/GitHub/DirectConvolution.jl/src/udwt.jl::75][udwt.jl:75]], [[KnhcZUtD][back to index]]
 ...
 Creates an instance
 #+END_QUOTE
 [[file:/home/picaud/GitHub/DirectConvolution.jl/src/udwt.jl::85][udwt.jl:85]], [[KnhcZUtD][back to index]]
 :END:
