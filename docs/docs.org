...
<<64sgHVDI>> *Index:* *[L]* [[sv4sAyq1][LinearFilter]] *[f]* [[KByzRtwf][fcoef]] *[l]* [[3TxWAHbW][length]] *[o]* [[Uzl5GpSg][offset]] *[r]* [[rR8oLKof][range]] 
- @@latex:\phantomsection@@ *=LinearFilter=*  <<sv4sAyq1>> <<pdJQtsnCLinearFilter>>
...
#+END_QUOTE
[[file:/home/picaud/GitHub/DirectConvolution.jl/src/linearFilter.jl::7][linearFilter.jl:7]], [[64sgHVDI][back to index]]
...
The *offset* is the position of the filter coefficient to be aligned with zero, see [[pdJQtsnCrange_filter][range(...)]].
...
#+END_QUOTE
[[file:/home/picaud/GitHub/DirectConvolution.jl/src/linearFilter.jl::104][linearFilter.jl:104]], [[64sgHVDI][back to index]]
...
#+END_QUOTE
[[file:/home/picaud/GitHub/DirectConvolution.jl/src/linearFilter.jl::118][linearFilter.jl:118]], [[64sgHVDI][back to index]]
- @@latex:\phantomsection@@ *=fcoef=*  <<KByzRtwf>>
#+BEGIN_SRC julia :eval never :exports code
...
#+END_QUOTE
[[file:/home/picaud/GitHub/DirectConvolution.jl/src/linearFilter.jl::13][linearFilter.jl:13]], [[64sgHVDI][back to index]]
- @@latex:\phantomsection@@ *=length=*  <<3TxWAHbW>>
#+BEGIN_SRC julia :eval never :exports code
...
#+END_QUOTE
[[file:/home/picaud/GitHub/DirectConvolution.jl/src/linearFilter.jl::17][linearFilter.jl:17]], [[64sgHVDI][back to index]]
- @@latex:\phantomsection@@ *=offset=*  <<Uzl5GpSg>>
#+BEGIN_SRC julia :eval never :exports code
...
See: [[pdJQtsnCrange_filter][range(...)]]
#+END_QUOTE
[[file:/home/picaud/GitHub/DirectConvolution.jl/src/linearFilter.jl::20][linearFilter.jl:20]], [[64sgHVDI][back to index]]
- @@latex:\phantomsection@@ *=range=*  <<rR8oLKof>> <<pdJQtsnCrange_filter>>
#+BEGIN_SRC julia :eval never :exports code
...
$$
#+END_QUOTE
[[file:/home/picaud/GitHub/DirectConvolution.jl/src/linearFilter.jl::36][linearFilter.jl:36]], [[64sgHVDI][back to index]]
:END:
...
print_org_doc(documented_items,tag="BoundaryExtension",tag_to_ignore="Internal",header_level=0)
 ...
 <<JmNcPaR9>> *Index:* *[B]* [[Pb8KSQlk][BoundaryExtension]] *[C]* [[u5mDv99G][ConstantBE]] *[M]* [[DJ77PuMS][MirrorBE]] *[P]* [[mzihGf89][PeriodicBE]] *[Z]* [[T7tefBui][ZeroPaddingBE]] 
 - @@latex:\phantomsection@@ *=BoundaryExtension=*  <<Pb8KSQlk>>
 #+BEGIN_SRC julia :eval never :exports code
 ...
 #+END_QUOTE
 [[file:/home/picaud/GitHub/DirectConvolution.jl/src/directConvolution.jl::11][directConvolution.jl:11]], [[JmNcPaR9][back to index]]
 - @@latex:\phantomsection@@ *=ConstantBE=*  <<u5mDv99G>>
 #+BEGIN_SRC julia :eval never :exports code
 struct ConstantBE <: BoundaryExtension
 #+END_SRC
 [[file:/home/picaud/GitHub/DirectConvolution.jl/src/directConvolution.jl::21][directConvolution.jl:21]], [[JmNcPaR9][back to index]]
 - @@latex:\phantomsection@@ *=MirrorBE=*  <<DJ77PuMS>>
 #+BEGIN_SRC julia :eval never :exports code
 struct MirrorBE <: BoundaryExtension
 #+END_SRC
 [[file:/home/picaud/GitHub/DirectConvolution.jl/src/directConvolution.jl::25][directConvolution.jl:25]], [[JmNcPaR9][back to index]]
 - @@latex:\phantomsection@@ *=PeriodicBE=*  <<mzihGf89>>
 #+BEGIN_SRC julia :eval never :exports code
 struct PeriodicBE <: BoundaryExtension
 #+END_SRC
 [[file:/home/picaud/GitHub/DirectConvolution.jl/src/directConvolution.jl::23][directConvolution.jl:23]], [[JmNcPaR9][back to index]]
 - @@latex:\phantomsection@@ *=ZeroPaddingBE=*  <<T7tefBui>>
 #+BEGIN_SRC julia :eval never :exports code
 struct ZeroPaddingBE <: BoundaryExtension
 #+END_SRC
 [[file:/home/picaud/GitHub/DirectConvolution.jl/src/directConvolution.jl::19][directConvolution.jl:19]], [[JmNcPaR9][back to index]]
 :END:
...
print_org_doc(documented_items,tag="Convolution",tag_to_ignore="Internal",header_level=0)
 ...
 <<Er7Dw0ix>> *Index:* *[d]* [[TpT5lpCb][directConv]], [[BTPP4kOm][directConv!]], [[IZudx2xr][directCrossCorrelation]] 
 - @@latex:\phantomsection@@ *=directConv=*  <<TpT5lpCb>>
 #+BEGIN_SRC julia :eval never :exports code
 ...
 component using [[y0fAOAt9directConv_details][directConv!(...)]]
 ...
 *Example:*
 ...
 #+END_QUOTE
 [[file:/home/picaud/GitHub/DirectConvolution.jl/src/directConvolution.jl::296][directConvolution.jl:296]], [[Er7Dw0ix][back to index]]
 ...
 *Returns:* $\gamma$ a created vector of length identical to the $\beta$ one.
 #+END_QUOTE
 [[file:/home/picaud/GitHub/DirectConvolution.jl/src/directConvolution.jl::342][directConvolution.jl:342]], [[Er7Dw0ix][back to index]]
 - @@latex:\phantomsection@@ *=directConv!=*  <<BTPP4kOm>> <<y0fAOAt9directConv_details>>
 #+BEGIN_SRC julia :eval never :exports code
 function directConv!(α::LinearFilter{T},
		      λ::Int,
 ...
 *Example:*
 ...
 #+END_QUOTE
 [[file:/home/picaud/GitHub/DirectConvolution.jl/src/directConvolution.jl::239][directConvolution.jl:239]], [[Er7Dw0ix][back to index]]
 - @@latex:\phantomsection@@ *=directCrossCorrelation=*  <<IZudx2xr>>
 #+BEGIN_SRC julia :eval never :exports code
 ...
 *Returns:* $\gamma$ a created vector of length identical to the $\beta$ one.
 #+END_QUOTE
 [[file:/home/picaud/GitHub/DirectConvolution.jl/src/directConvolution.jl::361][directConvolution.jl:361]], [[Er7Dw0ix][back to index]]
 :END:
...
<<pa9OP8Pc>> *Index:* *[S]* [[VPX38PMB][SG_Filter]] *[f]* [[fCHxQZzo][filter]] *[l]* [[wyR6YKsP][length]] *[m]* [[tXOICVwM][maxDerivativeOrder]] *[p]* [[DQj0tzJZ][polynomialOrder]] 
- @@latex:\phantomsection@@ *=SG_Filter=*  <<VPX38PMB>>
#+BEGIN_SRC julia :eval never :exports code
...
#+END_QUOTE
[[file:/home/picaud/GitHub/DirectConvolution.jl/src/SG_Filter.jl::30][SG_Filter.jl:30]], [[pa9OP8Pc][back to index]]
 @@latex:\phantomsection@@  <<Q9dEQVG2SG_Filters_Constructor>>
#+BEGIN_SRC julia :eval never :exports code
...
#+END_QUOTE
[[file:/home/picaud/GitHub/DirectConvolution.jl/src/SG_Filter.jl::55][SG_Filter.jl:55]], [[pa9OP8Pc][back to index]]
- @@latex:\phantomsection@@ *=filter=*  <<fCHxQZzo>>
#+BEGIN_SRC julia :eval never :exports code
...
#+END_QUOTE
[[file:/home/picaud/GitHub/DirectConvolution.jl/src/SG_Filter.jl::37][SG_Filter.jl:37]], [[pa9OP8Pc][back to index]]
- @@latex:\phantomsection@@ *=length=*  <<wyR6YKsP>>
#+BEGIN_SRC julia :eval never :exports code
length(sg::SG_Filter{T,N}) where {T<:AbstractFloat,N}
#+END_SRC
#+BEGIN_QUOTE
Returns filter length, this is an odd number, see [[Q9dEQVG2SG_Filters_Constructor][SG_Filter(...)]]
#+END_QUOTE
[[file:/home/picaud/GitHub/DirectConvolution.jl/src/SG_Filter.jl::42][SG_Filter.jl:42]], [[pa9OP8Pc][back to index]]
- @@latex:\phantomsection@@ *=maxDerivativeOrder=*  <<tXOICVwM>>
#+BEGIN_SRC julia :eval never :exports code
...
#+END_QUOTE
[[file:/home/picaud/GitHub/DirectConvolution.jl/src/SG_Filter.jl::46][SG_Filter.jl:46]], [[pa9OP8Pc][back to index]]
- @@latex:\phantomsection@@ *=polynomialOrder=*  <<DQj0tzJZ>>
#+BEGIN_SRC julia :eval never :exports code
polynomialOrder(sg::SG_Filter{T,N}) where {T<:AbstractFloat,N}
#+END_SRC
#+BEGIN_QUOTE
Returns the degree of the polynomial used to construct the Savitzky-Golay filters, see [[Q9dEQVG2SG_Filters_Constructor][SG_Filter(...)]].
#+END_QUOTE
[[file:/home/picaud/GitHub/DirectConvolution.jl/src/SG_Filter.jl::51][SG_Filter.jl:51]], [[pa9OP8Pc][back to index]]
:END:
