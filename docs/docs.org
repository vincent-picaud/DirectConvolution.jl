...
print_org_doc(documented_items,tag="BoundaryExtension",header_level=0)
 ...
 <<tLdQuxIm>> *Index:* *[B]* [[Mb8TLk97][BoundaryExtension]] *[C]* [[AoXflals][ConstantBE]] *[M]* [[9rpiK7Ob][MirrorBE]] *[P]* [[UXAjb87O][PeriodicBE]] *[Z]* [[x1CSlWZ3][ZeroPaddingBE]] *[c]* [[iyycNPpx][compute_Ωγ1]] *[r]* [[YJzx2ObS][relativeComplement_left]], [[JYPeMAzu][relativeComplement_right]] *[s]* [[8XXACRuM][scale]] 
 - @@latex:\phantomsection@@ *=BoundaryExtension=*  <<Mb8TLk97>>
 #+BEGIN_SRC julia :eval never :exports code
 ...
 #+END_SRC
 #+END_QUOTE
 [[file:/home/picaud/GitHub/DirectConvolution.jl/src/directConvolution.jl::11][directConvolution.jl:11]], [[tLdQuxIm][back to index]]
 - @@latex:\phantomsection@@ *=ConstantBE=*  <<AoXflals>>
 #+BEGIN_SRC julia :eval never :exports code
 struct ConstantBE <: BoundaryExtension
 #+END_SRC
 [[file:/home/picaud/GitHub/DirectConvolution.jl/src/directConvolution.jl::21][directConvolution.jl:21]], [[tLdQuxIm][back to index]]
 - @@latex:\phantomsection@@ *=MirrorBE=*  <<9rpiK7Ob>>
 #+BEGIN_SRC julia :eval never :exports code
 struct MirrorBE <: BoundaryExtension
 #+END_SRC
 [[file:/home/picaud/GitHub/DirectConvolution.jl/src/directConvolution.jl::25][directConvolution.jl:25]], [[tLdQuxIm][back to index]]
 - @@latex:\phantomsection@@ *=PeriodicBE=*  <<UXAjb87O>>
 #+BEGIN_SRC julia :eval never :exports code
 struct PeriodicBE <: BoundaryExtension
 #+END_SRC
 [[file:/home/picaud/GitHub/DirectConvolution.jl/src/directConvolution.jl::23][directConvolution.jl:23]], [[tLdQuxIm][back to index]]
 - @@latex:\phantomsection@@ *=ZeroPaddingBE=*  <<x1CSlWZ3>>
 #+BEGIN_SRC julia :eval never :exports code
 struct ZeroPaddingBE <: BoundaryExtension
 #+END_SRC
 [[file:/home/picaud/GitHub/DirectConvolution.jl/src/directConvolution.jl::19][directConvolution.jl:19]], [[tLdQuxIm][back to index]]
 - @@latex:\phantomsection@@ *=compute_Ωγ1=*  <<iyycNPpx>>
 #+BEGIN_SRC julia :eval never :exports code
 ...
 *Example:*
 #+BEGIN_SRC julia
 DirectConvolution.compute_Ωγ1(1:20,-2,-1:2)
 #+END_SRC
 #+BEGIN_SRC julia
 39:38
 #+END_SRC
 #+END_QUOTE
 [[file:/home/picaud/GitHub/DirectConvolution.jl/src/directConvolution.jl::47][directConvolution.jl:47]], [[tLdQuxIm][back to index]]
 - @@latex:\phantomsection@@ *=relativeComplement_left=*  <<YJzx2ObS>>
 #+BEGIN_SRC julia :eval never :exports code
 ...
 *Example:*
 ...
 #+END_QUOTE
 [[file:/home/picaud/GitHub/DirectConvolution.jl/src/directConvolution.jl::69][directConvolution.jl:69]], [[tLdQuxIm][back to index]]
 - @@latex:\phantomsection@@ *=relativeComplement_right=*  <<JYPeMAzu>>
 #+BEGIN_SRC julia :eval never :exports code
 ...
 *Example:*
 ...
 #+END_QUOTE
 [[file:/home/picaud/GitHub/DirectConvolution.jl/src/directConvolution.jl::88][directConvolution.jl:88]], [[tLdQuxIm][back to index]]
 - @@latex:\phantomsection@@ *=scale=*  <<8XXACRuM>>
 #+BEGIN_SRC julia :eval never :exports code
 ...
 *Caveat:*
 ...
 #+END_SRC
 #+END_QUOTE
 [[file:/home/picaud/GitHub/DirectConvolution.jl/src/directConvolution.jl::30][directConvolution.jl:30]], [[tLdQuxIm][back to index]]
 :END:
...
print_org_doc(documented_items,tag="Convolution",header_level=0)
 ...
 <<MDCRmXoU>> *Index:* *[d]* [[bVNP3fdX][directConv]], [[SzFveKdQ][directConv!]] 
 - @@latex:\phantomsection@@ *=directConv=*  <<bVNP3fdX>>
 #+BEGIN_SRC julia :eval never :exports code
 ...
 #+END_QUOTE
 [[file:/home/picaud/GitHub/DirectConvolution.jl/src/directConvolution.jl::242][directConvolution.jl:242]], [[MDCRmXoU][back to index]]
 - @@latex:\phantomsection@@ *=directConv!=*  <<SzFveKdQ>>
 #+BEGIN_SRC julia :eval never :exports code
 function directConv!(tilde_α::AbstractArray{T,1},
		      α_offset::Int,
		      λ::Int,
 ...
 #+END_QUOTE
 [[file:/home/picaud/GitHub/DirectConvolution.jl/src/directConvolution.jl::164][directConvolution.jl:164]], [[MDCRmXoU][back to index]]
 ...
 Inplace modification of γ
 #+END_QUOTE
 [[file:/home/picaud/GitHub/DirectConvolution.jl/src/directConvolution.jl::202][directConvolution.jl:202]], [[MDCRmXoU][back to index]]
 :END:
